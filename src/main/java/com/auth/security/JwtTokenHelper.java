...
import com.auth.constant.JwtSecurityConstants;
import com.auth.entity.JwtToken;
import com.auth.repo.JwtTokenRepository;
...
public class JwtTokenHelper {
    ...
    @Autowired
    private JwtTokenRepository jwtTokenRepository; // Inject the repository
